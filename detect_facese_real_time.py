...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        video_capture = cv2.VideoCapture("./v1.mp4")
        c = 0
            ...
            if c % timeF == 0:
                ...
                if nrof_faces > 0:
                    ...
                    for i in range(nrof_faces):
                        ...
                        #                        print(predictions)
                        #                        DAT=np.column_stack((predictions))
                        #                        np.savetxt("PredValues.txt",DAT,newline='\n',delimiter=",",fmt="%s")
                        #                        def animate(i):
                        #                            y=predictions.transpose()
                        #                            ax1.clear()
                        #                            ax1.plot(xs,y)
                        #
